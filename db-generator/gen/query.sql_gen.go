...
SELECT category_id, category_name, description, picture FROM categories WHERE category_id = $1
`
...
SELECT product_id, product_name, quantity_per_unit, unit_price, unit_in_stock, unit_in_order, reorder_level, discontinued, supplier_id, category_id FROM products WHERE category_id = $1
`
...
SELECT category_id, category_name, description, picture FROM Categories ORDER BY category_name
`
...
SELECT product_id, product_name, quantity_per_unit, unit_price, unit_in_stock, unit_in_order, reorder_level, discontinued, supplier_id, category_id FROM products ORDER BY product_name
`
